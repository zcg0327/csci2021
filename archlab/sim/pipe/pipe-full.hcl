...
#
# 1.	Modifications exclusively include the addition of the iaddq
#		instruction from part (b). See the documentation for this
#		instruction in /sim/seq/seq-full.hcl
#
#
####################################################################
